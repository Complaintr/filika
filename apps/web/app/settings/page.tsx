...
const sections = [
  {
    ...
    description: "Your workspace name and dashboard defaults.",
  },
  {
    id: "appearance",
    label: "Appearance",
    icon: Paintbrush,
    description: "Theme and spacing that feel right for you.",
  },
  {
    id: "account",
    label: "Your account",
  ...
  return (
    <div className="settings-studio">
      <header className="page-heading">
        <div>
          <h1>Settings</h1>
          <p className="muted">A few preferences to make Filika feel like yours.</p>
        </div>
        <Link className="button filika-pill" href="/onboarding?edit=1">
      ...
      <div className="settings-layout">
        <aside className="settings-sidebar analytics-surface">
          ...
          <div className="analytics-inset settings-nav-inset">
            ...
            <div className="settings-sidebar-identity">
              <span>{(session?.user.name || draft.workspaceName).slice(0, 1).toUpperCase()}</span>
              <div>
                <strong>{session?.user.name || draft.workspaceName}</strong>
                <small>{session?.user.email || "Your Filika workspace"}</small>
              </div>
            </div>
        ...
        <div className="settings-content analytics-surface">
          <div className="analytics-surface-heading">
            <h2>{section.label}</h2>
            ...
            {active === "privacy" && (
              <div className="settings-section-body">
                <div className="privacy-intro">
                  ...
                  <p>
                    Filika collects the report a person chooses to send, after they have had a
                    chance to review it.
                  </p>
                </div>
                {[
